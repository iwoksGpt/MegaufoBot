...
export class TelegramAPI {
  ...
  sendMessage<T = { ok: boolean; result: { message_id: number } }>(chatId: number, text: string, replyMarkup?: ReplyMarkup) {
    return this.call<T>('sendMessage', {
      chat_id: chatId,
      text,
      parse_mode: 'Markdown',
  ...
  sendPhoto<T = { ok: boolean; result: { message_id: number } }>(chatId: number, photo: string, caption: string, replyMarkup?: ReplyMarkup) {
    return this.call<T>('sendPhoto', {
      chat_id: chatId,
      photo,
      caption,
      parse_mode: 'Markdown',
